...
export const useActivityStore = create<ActivityStore>((set, get) => ({
  ...
  async updateDueDate(activityId, dueDate) { await taskFlowRepository.updateDueDate(activityId, dueDate); await get().load(); },
